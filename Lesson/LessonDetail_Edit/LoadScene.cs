...
namespace LessonDetail_Edit
{
    public class LoadScene : MonoBehaviour
    {
        ...
        IEnumerator LoadCurrentLesson(LessonDetail currentLesson)
        {
            ...
            lessonTitle.gameObject.GetComponent<Text>().text = formatString(currentLesson.lessonTitle.ToLower(), calculatedSize);
            bodyObject.transform.GetChild(2).GetChild(0).GetChild(1).GetChild(0).GetComponent<Text>().text = formatString(currentLesson.authorName, calculatedSize);
